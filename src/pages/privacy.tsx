...
const Privacy = () => (
  <Main meta={<Meta title="Privacy" description="個人情報の取り扱いについて" />}>
    <Content>
      <p>
        当サイトにおける個人情報の取扱いについて、以下のとおりにプライバシーポリシーを定めます。
      </p>
      <p className="font-bold">Cookieについて</p>
      <p>
      ...
      <p className="font-bold">広告の配信について</p>
      <p>
      ...
      <p className="font-bold">アクセス解析ツールについて</p>
      <p>
      ...
      <p className="font-bold">著作権について</p>
      <p>
      ...
      <p className="font-bold">プライバシーポリシーの変更について</p>
      <p>
